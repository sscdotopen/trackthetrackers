...
object VertexCount extends App {
  ...
  count("/home/ssc/Entwicklung/projects/trackthetrackers/analysis/src/main/resources/cfindergoogle/links.tsv",
        "/tmp/flink-scala/numVertices")
  ...
  def count(linksFile: String, outputPath: String) = {
    ...
    numVertices.writeAsText(outputPath, WriteMode.OVERWRITE)
