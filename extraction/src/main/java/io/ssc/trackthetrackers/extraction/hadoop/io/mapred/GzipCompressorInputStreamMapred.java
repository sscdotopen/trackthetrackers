...
public class GzipCompressorInputStreamMapred extends CompressorInputStreamMapred {
  ...
  // True once the end of a member has been reached and
  // 'decompressConcatenated' is false.
  private boolean stoppedForEndOfMember = false;

  // True once the end of stream has been reached.
   ...
   */
  public GzipCompressorInputStreamMapred(InputStream inputStream)
      throws IOException {
  ...
  private boolean init(boolean isFirstMember) throws IOException {
    //assert isFirstMember || decompressConcatenated; //throws error !!!
